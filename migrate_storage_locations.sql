...
ALTER TABLE equipment_types
    ADD CONSTRAINT IF NOT EXISTS fk_type_home_loc
...
ALTER TABLE equipment_items
    ADD CONSTRAINT IF NOT EXISTS fk_item_cur_loc
        FOREIGN KEY (current_location_id) REFERENCES storage_locations(id) ON DELETE SET NULL,
    ADD CONSTRAINT IF NOT EXISTS fk_item_home_loc
        FOREIGN KEY (home_location_id)    REFERENCES storage_locations(id) ON DELETE SET NULL;
...
ALTER TABLE transactions
    ADD CONSTRAINT IF NOT EXISTS fk_txn_location
